/**
 * Icon registry — the source of truth for which icon names exist.
 *
 * Each entry is the inner SVG content (everything between <svg> and </svg>).
 * All icons are 24x24 viewBox, stroke-based, currentColor, 2px stroke.
 * Lucide-style aesthetic.
 *
 * Adding a new icon:
 *   1. Append an entry here with its name and inner SVG content.
 *   2. Add the name to the `AxIconName` union type.
 *   3. Add a test entry to icons.spec.ts.
 *
 * Codegen pipeline: `scripts/extract-svg-paths.ts` will eventually
 * generate this file from `svg/*.svg` (in v0.2, when we expand to 80+).
 */
...
export const ICON_REGISTRY = {
  ...
  'file-code': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M10 13l-2 2 2 2"/><path d="M14 13l2 2-2 2"/>',
  'file-image': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="10" cy="13" r="2"/><path d="M20 17l-3.5-3.5L9 21"/>',
...
/** The union of all valid icon names. */
export type AxIconName = keyof typeof ICON_REGISTRY;

/** Default icon when the requested name is not in the registry. */
export const FALLBACK_ICON_NAME: AxIconName = 'help-circle';
